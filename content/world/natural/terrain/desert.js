(function () {let $1=[x,x,x,x]//tmpn=0 or 100 (depth), tmp=x(scene), tmp2='in' or 'out'(direction)
    ...
    switch(tmp){
    case x:// standing
        t=`Progress: ${tmpn}%<br><br>You are in a desert, there is a ${$1[0]} ahead. The ${$1[1]} is behind you.`
    ...
    case 'walk':// travelling
        ...
        else{t=`Progress: ${tmpn}%<br><br>You are walking in the desert, there is a ${$1[0]} ahead. The ${$1[1]} is behind you.`
