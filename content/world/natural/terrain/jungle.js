(function () {let $1=[x,x,x,x]//tmpn=0 or 100 (depth), tmp=x(scene), tmp2='in' or 'out'(direction)
    ...
    switch(tmp){
    case x:// standing
        t=`Progress: ${tmpn}%<br><br>You are in a jungle, there is a ${$1[0]} ahead. The ${$1[1]} is behind you.`
    ...
    case 'walk':// travelling
        ...
        else{t=`Progress: ${tmpn}%<br><br>You are walking in the jungle, there is a ${$1[0]} ahead. The ${$1[1]} is behind you.`
    ...
    case 'explore':// exploring the area
        t=`You explore the jungle. `
        switch(rng(2)){
            case 0:t+=`Nothing happens.`;break;
            case 1:t+=`You find some some fruits.`;break;
            case 2:t+=`A spider bites you.`;break;}
