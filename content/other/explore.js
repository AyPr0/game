(function () {let $1=[x,x,'out',chunk[loc()].arr(0)]//tmpn=0 or 100 (depth), tmp=x(scene), tmp2='in' or 'out'(direction), current terrain
    if(tmp==x||tmp=='walk'){
    ...
    case x:// standing
        ...
        n+=`\${btn('explore',"ptime([20]);tmp='explore';t='You explore the ${$1[3]} and';next()")}`;break;
